    ...
    <div class="row Pi">
        <div class="col-lg-2 col-6 mt-3">
            <ul style="text-align:left;">
                <a href="/views/politicas.php"><li>Politicas de Privacidad</li></a>
                <li>Contactanos</li>
            </ul>
        </div>
        <div class="col-lg-2 col-6 mt-3">
        ...
        <div class="col-12 col-lg-4 mt-3" id="reds" style=" text-align:center; float:right;">
        <div class="flex-row d-flex justify-content-around">
            ...
            <a href="https://www.twitter.com" target="_blank"><div class="rs" id="t"></div></a>
        </div>
        </div>
    </div>
</div>
